...
public class Table< K , E >
{
   ...
   **/
   public E put(K key, E element)
   {
      ...
      System.out.println("TABLE:key is already in the table");
      ...
      //System.out.println(element + " is not yet in the table");    //DEBUG WORKING
         ...
         //System.out.println("TABLE" +element+ " had a collision at "+ index);    //DEBUG  WORKING
        ...
        // System.out.println(element +" put at " + index + " with " + collisions[manyItems] + " collisions"); //DEBUG WORKING
         manyItems++;
   ...
   **/
   public E remove(K key)
   {
	 ...
	 manyItems--;
      ...
      public double getLinearAverage(){  //method that is responsible for finding and returning the average number of collisions per item
         double sum=0;
         double avg;
