...
public class IntNode
{
   ...
   **/
   ...
   {
      link = new IntNode(item, link);          //new Intnode uses the current node's link to set it's link. 
                                               //after, this nodes link is set to the newly created node
   }                                          //if link of the current node is null, its ok, the reference of the new node is null
